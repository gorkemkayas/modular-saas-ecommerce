...
public sealed class SetDefaultShippingAddressCommandHandler : IRequestHandler<SetDefaultShippingAddressCommand>
{
    ...
    public async Task Handle(SetDefaultShippingAddressCommand command, CancellationToken cancellationToken)
    {
