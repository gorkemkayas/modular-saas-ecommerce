...
namespace Payment.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260605190647_RemovePaymentProviderAccountPlatformSettings")]
    partial class RemovePaymentProviderAccountPlatformSettings
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Payment.Domain.Entities.PaymentProviderAccount", b =>
                {
                    ...
                    b.Property<string>("DefaultBuyerIdentityNumber")
                        .IsRequired()
                        .HasMaxLength(30)
