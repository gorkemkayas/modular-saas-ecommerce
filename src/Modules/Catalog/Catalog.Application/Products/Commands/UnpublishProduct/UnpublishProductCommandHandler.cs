...
{
    public sealed class UnpublishProductCommandHandler : IRequestHandler<UnpublishProductCommand>
    {
        ...
        public async Task Handle(UnpublishProductCommand command, CancellationToken cancellationToken)
        {
